...
func (b *Booth) IssueGrant(transfer Transfer) (Grant, error) {
	...
	// The grant becomes actionable only after this local transition removes
	// the source's ability to use the same right and retains the transfer.
	b.rights[transfer.RightID] = RightRelinquished
